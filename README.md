...
| `users` | Manages user data by reading and caching the MUD's character files. Implements repository pattern to provide efficient access to character information while minimizing filesystem reads. |
